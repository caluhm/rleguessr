...
const HeroSection = () => {
  return (
    <div className='flex flex-col gap-5 sm:px-11 px-4 pb-10'>
        <div className='uppercase text-white font-bold sm:text-[5.5rem] text-[3rem] leading-[0.875] italic text-center'>
          <div className='font-semibold text-base bg-[#6366F1] hover:bg-yellow-500 transition-colors duration-500 ease-in-out w-min px-1.5 rounded not-italic mb-1 drop-shadow-md tracking-wide ml-auto text-center'>BETA</div>
