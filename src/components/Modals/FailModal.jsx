        ...
        <div className='relative m-auto overflow-hidden p-10 bg-[#0c101f] w-full max-w-[31.25rem] max-h-[calc(100vh-2.5rem)] outline-none flex flex-col rounded-md drop-shadow-lg' ref={ref}>
            ...
            <div className='z-1 mt-6'>
                <div className='relative flex flex-col items-center h-fit'>
                    <h1 className='text-3xl font-bold bg-clip-text text-white'>{FAIL_MODAL_TITLE_TEXT}</h1>
                </div>
                <div className='h-[0.0625rem] w-full bg-white/20 my-8 mx-auto'></div>
                <div className='text-center text-white uppercase font-bold mt-8 tracking-[0.04em] text-sm'>{FAIL_MODAL_BODY_TEXT_1}</div>
                ...
                <p className='text-center text-white uppercase font-bold my-8 tracking-[0.04em] text-sm'>{FAIL_MODAL_BODY_TEXT_3}</p>
                ...
                <div className='text-center text-white'>
                    <div className='text-base font-bold tracking-wide -mb-[8px]'>{FAIL_MODAL_FOOTER_TEXT}</div>
                    <Countdown
