...
const GuessGridHeader = () => {
  return (
    <>
        ...
        <div className='flex col-span-1 row-span-1 bg-[#28335a] rounded text-white font-semibold sm:text-sm text-xs text-center items-center justify-center tracking-[0.05em] h-[36px] uppercase' data-tooltip-id="my-tooltip" data-tooltip-content="The player's team that they currently play for or coach." data-tooltip-place="top">{GUESS_GRID_HEADER_TEAM_TEXT}</div>
        ...
        <div className='flex col-span-1 row-span-1 bg-[#28335a] rounded text-white font-semibold sm:text-sm text-xs text-center items-center justify-center tracking-[0.05em] h-[36px] uppercase' data-tooltip-id="my-tooltip" data-tooltip-content="The amount of RLCS LAN's the player has attended, only as a player." data-tooltip-place="top">{GUESS_GRID_HEADER_LANS_TEXT}</div>
    </>
  )
}
